    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            axios_1.default.post('http://localhost:3000/graphql', data, {
              headers: headers,
            }),
          ];
        case 1:
          ...
          return [
            ...
            __assign(
              __assign(
                {},
                (_a = response.data.data) === null || _a === void 0
                  ? void 0
                  : _a.createComment,
              ),
              {
                id:
                  (_c =
                    (_b = response.data.data) === null || _b === void 0
                      ? void 0
                      : _b.createComment) === null || _c === void 0
                    ? void 0
                    : _c.id,
              },
            ),
